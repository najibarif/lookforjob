...
<?php $__env->startSection('title', __('Salary Insights') . ' - LookForJob'); ?>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-12">
            <div class="flex items-center gap-3 mb-4">
                ...
                <div>
                    <h1 class="text-4xl font-bold text-slate-900 dark:text-white"><?php echo e(__('Salary Insights')); ?></h1>
                    <p class="text-slate-600 dark:text-slate-400 mt-2"><?php echo e(__('Discover market salary data to negotiate confidently')); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="grid lg:grid-cols-3 gap-8">
                    ...
                    <form id="salaryForm" class="space-y-6">
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-slate-900 dark:text-white mb-2">
                                <?php echo e(__('Job Title')); ?> <span class="text-red-500">*</span>
                            </label>
            ...
            <div class="lg:col-span-2">
                ...
                <div id="emptyState" class="bg-white dark:bg-slate-900 rounded-2xl shadow-lg border border-slate-100 dark:border-slate-800 p-12 text-center">
                    ...
                    <p class="text-slate-600 dark:text-slate-400"><?php echo e(__('Search for a job title to see salary insights')); ?></p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="space-y-4 animate-fade-in-up">
                        ...
                        <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-lg border border-slate-100 dark:border-slate-800 p-6">
                            <div class="flex items-center justify-between">
                                <div>
                                    <p class="text-sm font-medium text-slate-600 dark:text-slate-400"><?php echo e(__('Average Salary')); ?></p>
                        ...
                        <!-- Salary Range -->
                        <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-lg border border-slate-100 dark:border-slate-800 p-6">
                            <h3 class="text-lg font-bold text-slate-900 dark:text-white mb-4"><?php echo e(__('Salary Range by Experience')); ?></h3>
                            <div class="space-y-3">
                                <div class="flex justify-between items-center p-3 bg-slate-50 dark:bg-slate-800 rounded-lg">
                                    <span class="text-sm font-medium text-slate-600 dark:text-slate-400"><?php echo e(__('Entry Level')); ?></span>
                                    <span class="text-sm font-bold text-slate-900 dark:text-white">${result.data.salary_range.entry_level}</span>
                                </div>
                                <div class="flex justify-between items-center p-3 bg-slate-50 dark:bg-slate-800 rounded-lg">
                                    <span class="text-sm font-medium text-slate-600 dark:text-slate-400"><?php echo e(__('Mid Level')); ?></span>
                                    <span class="text-sm font-bold text-slate-900 dark:text-white">${result.data.salary_range.mid_level}</span>
                                </div>
                                <div class="flex justify-between items-center p-3 bg-slate-50 dark:bg-slate-800 rounded-lg">
                                    <span class="text-sm font-medium text-slate-600 dark:text-slate-400"><?php echo e(__('Senior Level')); ?></span>
                        ...
                        <!-- Top Skills -->
                        <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-lg border border-slate-100 dark:border-slate-800 p-6">
                            <h3 class="text-lg font-bold text-slate-900 dark:text-white mb-4"><?php echo e(__('Top Required Skills')); ?></h3>
                        ...
                        <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-lg border border-slate-100 dark:border-slate-800 p-6">
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <p class="text-sm font-medium text-slate-600 dark:text-slate-400"><?php echo e(__('Market Demand')); ?></p>
                                    <p class="text-2xl font-bold text-slate-900 dark:text-white mt-2">${result.data.market_demand.high}%</p>
                                    <p class="text-xs text-slate-500 dark:text-slate-500 mt-1"><?php echo e(__('High Demand')); ?></p>
                                </div>
                                <div>
                                    <p class="text-sm font-medium text-slate-600 dark:text-slate-400"><?php echo e(__('Job Growth')); ?></p>
                                    <p class="text-2xl font-bold text-slate-900 dark:text-white mt-2">${result.data.job_growth}</p>
                                    <p class="text-xs text-slate-500 dark:text-slate-500 mt-1"><?php echo e(__('Annually')); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\LookForJob\resources\views/career-tools/salary-insights.blade.php ENDPATH**/ ?>