...
@section('title', __('Interview Prep') . ' - LookForJob')
...
<section class="min-h-screen bg-gradient-to-br from-emerald-50 dark:from-emerald-950/40 via-white dark:via-slate-950 to-teal-50 dark:to-teal-950/40 py-20">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-12 text-center">
            ...
            <h1 class="text-4xl font-bold text-slate-900 dark:text-white">{{ __('Interactive AI Interview') }}</h1>
            <p class="text-slate-600 dark:text-slate-400 mt-2">{{ __('Practice speaking with our AI interviewer') }}</p>
        </div>
