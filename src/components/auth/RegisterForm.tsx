...
const schema = yup
    .object({
        ...
        role: yup
            ...
            .oneOf(["pencari kerja", "recruiter"] as const, "Pilihan peran tidak valid"),
        alamat: yup.string().nullable().optional(),
        tanggal_lahir: yup.string().nullable().optional(),
        jenis_kelamin: yup
            .string()
            .oneOf(["L", "P", ""] as const, "Jenis kelamin tidak valid")
            .nullable()
            .optional(),
