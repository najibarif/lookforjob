...
const EducationForm: React.FC<EducationFormProps> = ({
  ...
  const defaultValues: FormData = {
    ...
    tanggal_mulai: education?.tanggal_mulai ? new Date(education.tanggal_mulai) : new Date(),
    tanggal_akhir: education?.tanggal_akhir ? new Date(education.tanggal_akhir) : null,
    ipk: education?.ipk || null,
  ...
  const onSubmit = async (data: FormData) => {
    try {
      ...
      if (isEditing && education?.id) {
        await educationAPI.updateEducation(education.id, formattedData);
        toast.success('Education updated successfully');
      } else {
        await educationAPI.createEducation(formattedData);
